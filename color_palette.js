!function ($) {
    var colorPalette = function(element, settings){
        this.baseElement = $(element);
        this.options = settings;
        this.colorButtons = function() {
            return this.baseElement.find('.color-button');
        };
        this.initialize();
    };
    ...
    colorPalette.prototype = {
        initialize: function () {
            ...
            this.addBorderOnClick();
            return;
        },
        buildColorPalette: function () {
            var colors = this.options.colors;
            for (var i = 0; i < colors.length; ++i) {
                var colorButton = this.makeColorButton(colors[i]);
                this.baseElement.append(colorButton);
            }
        },
        ...
        addBorderOnClick: function () {
            var s = this;
            $(this.baseElement).on('click', '.color-button', function () {
                var colorButtons = s.colorButtons();
